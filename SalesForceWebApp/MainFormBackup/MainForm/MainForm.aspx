<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainForm.aspx.cs" Inherits="SalesForceWebApp.Register" %>
                ...
                <ajaxToolkit:TabPanel ID="tpnlGeneralInfo" runat="server" HeaderText="General Information" CssClass="TopTabPanel" >
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="pnlFamilyInformation" runat="server" GroupingText="Family Information" CssClass="downLeftPanel">
                            <asp:Panel ID="pnlFamilyInfoSpouse" runat="server" Width="98%" GroupingText="Spouse" CssClass="floatSpouse">
                                <asp:Panel ID="pnlSpouseInfo" runat="server" Width="230px" CssClass="floatSubPanelSpouse">
                                    <asp:Label ID="lblSpouseNameLabel" runat="server" Width="220px" Text="Name" CssClass="pnlLabelSpouseInfo" Visible="False"></asp:Label><br />
                                    <asp:Label ID="lblSpouseName" runat="server" Width="220px" CssClass="SpouseName" Font-Size="14px" Visible="False"></asp:Label>
                                </asp:Panel>

                                <asp:Panel ID="pnlSpouseDateOfBirth" runat="server" Width="100px" CssClass="floatSubPanelSpouse">
                                    <asp:Label ID="lblSpouseDateOfBirthLabel" runat="server" Width="90px" Text="Date of Birth" CssClass="pnlLabelSpouseInfo" Visible="False"></asp:Label><br />
                                    <asp:Label ID="lblSpouseDateOfBirth" runat="server" Width="105px" CssClass="SpouseDateOfBirth" Font-Size="14px" Visible="False"></asp:Label>
                                </asp:Panel>

                                <asp:Panel ID="pnlSpouseStartDate" runat="server" Width="100px" CssClass="floatSubPanelSpouse">
                                    <asp:Label ID="lblSpouseStartDateLabel" runat="server" Width="90px" Text="Start Date" CssClass="pnlLabelSpouseInfo" Visible="False"></asp:Label><br />
                                    <asp:Label ID="lblSpouseStartDate" runat="server" Width="90px" CssClass="SpouseStartDate" Font-Size="14px" Visible="False"></asp:Label>
                                </asp:Panel>

                            </asp:Panel>

                            <asp:Panel ID="pnlFamilyInfoChildren" runat="server" Width="98%" GroupingText="Children" CssClass="floatChildren">
                                <asp:Panel ID="pnlChildrenName" runat="server" Width="230px" CssClass="floatSubPanelChildren">
                                    <asp:Label ID="lblChildrenName" runat="server" Width="220px" CssClass="pnlLabelChildrenInfo" Text="Name" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildName1" runat="server" Width="220px" CssClass="lblChildrenName" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildName2" runat="server" Width="220px" CssClass="lblChildrenName" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildName3" runat="server" Width="220px" CssClass="lblChildrenName" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildName4" runat="server" Width="220px" CssClass="lblChildrenName" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildName5" runat="server" Width="220px" CssClass="lblChildrenName" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildName6" runat="server" Width="220px" CssClass="lblChildrenName" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildName7" runat="server" Width="220px" CssClass="lblChildrenName" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildName8" runat="server" Width="220px" CssClass="lblChildrenName" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildName9" runat="server" Width="220px" CssClass="lblChildrenName" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildName10" runat="server" Width="220px" CssClass="lblChildrenName" Visible="False"></asp:Label>
                                </asp:Panel>
                                <asp:Panel ID="pnlChildrenDateOfBirth" runat="server" Width="100px" CssClass="floatSubPanelChildren">
                                    <asp:Label ID="lblChildrenDateOfBirth" runat="server" Width="90px" CssClass="pnlLabelChildrenInfo" Text="Date of Birth" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildDateOfBirth1" runat="server" Width="90px" CssClass="lblChildrenDateOfBirth" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildDateOfBirth2" runat="server" Width="90px" CssClass="lblChildrenDateOfBirth" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildDateOfBirth3" runat="server" Width="90px" CssClass="lblChildrenDateOfBirth" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildDateOfBirth4" runat="server" Width="90px" CssClass="lblChildrenDateOfBirth" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildDateOfBirth5" runat="server" Width="90px" CssClass="lblChildrenDateOfBirth" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildDateOfBirth6" runat="server" Width="90px" CssClass="lblChildrenDateOfBirth" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildDateOfBirth7" runat="server" Width="90px" CssClass="lblChildrenDateOfBirth" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildDateOfBirth8" runat="server" Width="90px" CssClass="lblChildrenDateOfBirth" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildDateOfBirth9" runat="server" Width="90px" CssClass="lblChildrenDateOfBirth" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildDateOfBirth10" runat="server" Width="90px" CssClass="lblChildrenDateOfBirth" Visible="False"></asp:Label>

                                </asp:Panel>
                                <asp:Panel ID="pnlChildrenStartDate" runat="server" Width="100px" CssClass="floatSubPanelChildren">
                                    <asp:Label ID="lblChildrenStartDate" runat="server" Width="90px" CssClass="pnlLabelChildrenInfo" Text="Start Date" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildStartDate1" runat="server" Width="90px" CssClass="lblChildrenStartDate" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildStartDate2" runat="server" Width="90px" CssClass="lblChildrenStartDate" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildStartDate3" runat="server" Width="90px" CssClass="lblChildrenStartDate" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildStartDate4" runat="server" Width="90px" CssClass="lblChildrenStartDate" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildStartDate5" runat="server" Width="90px" CssClass="lblChildrenStartDate" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildStartDate6" runat="server" Width="90px" CssClass="lblChildrenStartDate" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildStartDate7" runat="server" Width="90px" CssClass="lblChildrenStartDate" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildStartDate8" runat="server" Width="90px" CssClass="lblChildrenStartDate" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildStartDate9" runat="server" Width="90px" CssClass="lblChildrenStartDate" Visible="False"></asp:Label>
                                    <asp:Label ID="lblChildStartDate10" runat="server" Width="90px" CssClass="lblChildrenStartDate" Visible="False"></asp:Label>
