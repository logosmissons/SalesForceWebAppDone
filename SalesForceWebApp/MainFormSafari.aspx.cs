...
{
    public partial class MainFormSafari : System.Web.UI.Page
    {
        ...
        protected void LoadPersonalInfo()
        {
            ...
            if (queryResultContactForMichaelJordan.size > 0)
            {
                ...
                if (ctMichaelJordan.cmm_Gender__c == "M") rbMale.Checked = true;
                else if (ctMichaelJordan.cmm_Gender__c == "F") rbFemale.Checked = true;
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                if (qrMembershipInfo.size > 0)
                {
                    ...
                    if (rbOneTime.Checked) updateMembershipInfo.cmm_Payment_Frequency__c = "One Time";
